...
public:
  ...
  {
    return mutable_indexed_substitution<VariableType, ExpressionType>(m_container, m_index_table, m_free_positions, m_variables_in_rhs_set_is_defined, m_variables_in_rhs);
  }
