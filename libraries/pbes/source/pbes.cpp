...
void normalize_sorts(pbes_system::pbes_expression& result, const pbes_system::pbes_expression& x, const data::sort_specification& sortspec) { pbes_system::normalize_sorts< pbes_system::pbes_expression >(result, x, sortspec); }
